...
def Plot_2D_time_height_flux(ds=None, var=None, gph=False, log=False, concentration=False, diff_type=None, 
                       lat_r=[-90,90], y_r=None, nxticks=6, exp=None, qr=None,diffqr=None,
                       cont=True, ncont=[False,False,10], fill=True, nfill=100, diffcont=[False,False,10], fontsize=10,cont_label_size=15, savefig=False, filename=None,suptitle=None,x_size=6.5,y_size=8):
   
    
    '''
    NAME:
           Plot_2D_time_height_flux
    ...
    if cont:
        # lined cont
        cs_nonrr=ds0.plot.contour(vmin=ncont[0],vmax=ncont[1],
                                  ylim=[y_r[0],y_r[1]],
                                  levels=ncont[2],
                                  colors="k",
                                  linewidths=1,
    ...
    if cont:
        # lined cont
        cs_rr=ds1.plot.contour(vmin=ncont[0],vmax=ncont[1],
                               ylim=[y_r[0],y_r[1]],
                               levels=ncont[2],
                               colors="k",
                               linewidths=1,
    ...
    if diff_type!=None:
        ...
        cbar2.set_ticklabels([f'{tick:.2f}' for tick in custom_ticks])   
        ...
        if cont:
            # lined cont
            cs_diff=ds_diff.plot.contour(vmin=diffcont[0],vmax=diffcont[1],
                                         ylim=[y_r[0],y_r[1]],
                                         levels=diffcont[2],
                                         colors="k",
                                         linewidths=1,
    ...
    if var!='T':            
        if concentration==True:
            ...
            if log==True:
                ax[0].set_title("log10(" +var + ")  ds0 " + scalestr,fontsize=fontsize)
                ax[1].set_title("log10(" +var + ")  ds1 " + scalestr,fontsize=fontsize)
            else:
                ax[0].set_title(var + "  ds0 " + scalestr,fontsize=fontsize)
                ax[1].set_title(var + "  ds1 " + scalestr,fontsize=fontsize)
