...
def Plot_2D_time_height(ds=None, var=None, gph=False, log=False, concentration=False, diff_type=None, 
                       ...
                       cont=True, ncont1=10,ncont2=10,fill=True, nfill=100, diffcont=10, fontsize=10,cont_label_size=15, savefig=False, filename=None,suptitle=None,x_size=6.5,y_size=8, fmt1_cbar=2,fmt2_cbar=2,fmtdiff_cbar=2,fmt1_cont=2,fmt2_cont=2,fmtdiff_cont=2):
    '''
    NAME:
           Plot_2D_time_height
    PURPOSE:
